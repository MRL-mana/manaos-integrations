...
- `phase1_run_off_3rounds` - OFF 3往復テスト（APIが 127.0.0.1:9510 で PHASE1_REFLECTION=off で起動していること）
...
- `MANAOS_INTEGRATION_API_URL`: ManaOS統合APIのURL（デフォルト: http://127.0.0.1:9510）
- `PORTAL_INTEGRATION_URL`: Portal APIのURL（デフォルト: http://127.0.0.1:5108）
