...
# 新しいウィンドウでサーバーを起動（PORT=9510）
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'C:\Users\mana4\Desktop\manaos_integrations'; `$env:PORT='9510'; py -3.10 unified_api_server.py" -WorkingDirectory (Get-Location)
...
Write-Host "1. ブラウザで http://127.0.0.1:9510/health にアクセス" -ForegroundColor White
