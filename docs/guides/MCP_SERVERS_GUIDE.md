...
| 変数 | 用途 | デフォルト |
|------|------|-----------|
| `MANAOS_INTEGRATION_API_URL` | 統合API URL | http://localhost:9500 |
| `PORTAL_INTEGRATION_URL` | Portal API（デバイス詳細） | http://localhost:5108 |
| `MCP_DOMAIN` | ツール分割（media/productivity/ai/devices/moltbot） | 空=全ツール |
| `COMFYUI_URL` | ComfyUI | http://localhost:8188 |
