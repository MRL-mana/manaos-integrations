...
def import_workflow(workflow_path, n8n_url="http://localhost:5678", api_key=None):
    """
    n8nワークフローをインポート
    ...
    try:
        ...
        print(f"   Please check if n8n is running")
        return False
...
def main():
    ...
    # デフォルトAPIキー（提供された場合）
    if not api_key:
        api_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJmNjE3NWI0NS03YzE5LTRmMDUtYWYxMS03MTc2OTRmMzVlNTkiLCJpc3MiOiJuOG4iLCJhdWQiOiJwdWJsaWMtYXBpIiwiaWF0IjoxNzY3MjUyMzcyfQ.A4PaU3urJVcrTy-6rzBSkDYjdUgotRhMG9bhKDe2_Yw"
