...
try:
    from manaos_integrations._paths import N8N_PORT, UNIFIED_API_PORT
except Exception:  # pragma: no cover
    try:
        from _paths import N8N_PORT, UNIFIED_API_PORT  # type: ignore
    except Exception:  # pragma: no cover
...
REQUIRED_ENV_VARS = {
    "manaos_unified_mcp_server": [
        ...
        ("MANAOS_INTEGRATION_API_URL", False, f"http://127.0.0.1:{UNIFIED_API_PORT}"),
        ("OBSIDIAN_VAULT_PATH", False, "/app/obsidian_vault"),
    ],
    "n8n_mcp_server": [
        ("N8N_BASE_URL", False, f"http://127.0.0.1:{N8N_PORT}"),
