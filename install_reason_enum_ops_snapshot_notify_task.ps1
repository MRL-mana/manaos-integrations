...
$jobScript = Join-Path $scriptDir "run_reason_enum_ops_snapshot_notify_once.ps1"
...
Write-Host "=== Register Reason Enum Ops Snapshot Notify Task ===" -ForegroundColor Cyan
