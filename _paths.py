...
LLM_ROUTING_PORT: int = int(os.getenv("LLM_ROUTING_PORT", "5111"))  # 正規値 5111 (services_ledger / manaos_llm_routing_api に一致)
...
SLACK_INTEGRATION_PORT: int = int(os.getenv("SLACK_INTEGRATION_PORT", "5590"))  # ledger SSOT 5590
FILE_SECRETARY_PORT: int = int(os.getenv("FILE_SECRETARY_PORT", "5120"))
LINE_NOTIFY_PORT: int = int(os.getenv("LINE_NOTIFY_PORT", "5591"))  # ledger SSOT 5591
...
STEP_DEEP_RESEARCH_PORT: int = int(
    os.getenv("STEP_DEEP_RESEARCH_PORT", "5120")  # ledger SSOT 5120
)
...
# ── MCP サーバー内蔵ヘルスチェックポート ─────────────────
PERSONALITY_MCP_HEALTH_PORT: int = int(os.getenv("PERSONALITY_MCP_HEALTH_PORT", "5143"))
AUTONOMY_MCP_HEALTH_PORT: int = int(os.getenv("AUTONOMY_MCP_HEALTH_PORT", "5144"))
SECRETARY_MCP_HEALTH_PORT: int = int(os.getenv("SECRETARY_MCP_HEALTH_PORT", "5145"))
TRINITY_MCP_HEALTH_PORT: int = int(os.getenv("TRINITY_MCP_HEALTH_PORT", "5146"))
PERSONALITY_THOUGHT_SYSTEM_PORT: int = int(os.getenv("PERSONALITY_THOUGHT_SYSTEM_PORT", "5126"))
PERSONALITY_THOUGHT_MCP_HEALTH_PORT: int = int(os.getenv("PERSONALITY_THOUGHT_MCP_HEALTH_PORT", "5147"))
