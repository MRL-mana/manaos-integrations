        ...
        <div class="dashboard">
            ...
            <div class="card">
                ...
                <div style="display: flex; flex-direction: column; gap: 10px;">
                    <a href="http://localhost:5092" target="_blank" style="padding: 10px; background: #667eea; color: white; text-decoration: none; border-radius: 8px; text-align: center;">🖼️ 画像ギャラリー</a>
                    <a href="http://localhost:5093" target="_blank" style="padding: 10px; background: #764ba2; color: white; text-decoration: none; border-radius: 8px; text-align: center;">🎨 画像生成</a>
                    <a href="http://localhost:8188" target="_blank" style="padding: 10px; background: #28a745; color: white; text-decoration: none; border-radius: 8px; text-align: center;">🔧 ComfyUI</a>
                    <a href="http://localhost:7860" target="_blank" style="padding: 10px; background: #ffc107; color: black; text-decoration: none; border-radius: 8px; text-align: center;">⚡ A1111</a>
                </div>
            </div>
        </div>
