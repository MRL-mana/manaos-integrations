...
- `ORCHESTRATOR_URL` - Web音声が叩くオーケストレータ（例: http://127.0.0.1:5106）
- `UNIFIED_API_URL` - 秘書レミ・音声APIのベース（例: http://127.0.0.1:9502）
- `INTENT_ROUTER_URL` - 意図分類（例: http://127.0.0.1:5100）
- `LLM_ROUTING_URL` - LLMルーティング（例: http://127.0.0.1:5111）
