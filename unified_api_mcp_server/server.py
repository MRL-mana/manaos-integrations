...
def call_api(endpoint: str, method: str = "GET", data: Optional[Dict[str, Any]] = None, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "folder_name": {"type": "string", "description": "アップロード先フォルダ名"},
                        "file_name": {"type": "string", "description": "アップロード後のファイル名"}
                    },
                    "required": ["file_path"]
                }
            )
        ...
        tools.extend([
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "query": {"type": "string", "description": "検索クエリ（必須）"},
                        "categories": {"type": "string", "description": "カテゴリ（カンマ区切り）"},
                        "engines": {"type": "string", "description": "検索エンジン（カンマ区切り）"},
                        "limit": {"type": "integer", "description": "取得件数（デフォルト: 10）", "default": 10}
                    },
                    "required": ["query"]
                }
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "query": {"type": "string", "description": "検索クエリ（必須）"},
                        "count": {"type": "integer", "description": "取得件数（デフォルト: 10）", "default": 10},
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "conversation_id": {"type": "string", "description": "会話ID（オプション）"}
                    },
                    "required": ["message"]
                }
            )
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "folder": {"type": "string", "description": "フォルダパス（オプション）"}
                    },
        ...
        tools.extend([
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "metadata": {"type": "object", "description": "メタデータ（オプション）"},
                        "format_type": {"type": "string", "description": "フォーマットタイプ（auto/text/json/markdown）", "default": "auto"}
                    },
                    "required": ["content"]
                }
            ),
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "query": {"type": "string", "description": "検索クエリ（必須）"},
                        "scope": {"type": "string", "description": "検索スコープ（all/recent/important）", "default": "all"},
                        "limit": {"type": "integer", "description": "取得件数（デフォルト: 10）", "default": 10}
                    },
                    "required": ["query"]
                }
            ...
            Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "priority": {"type": "string", "description": "優先度（low/normal/high/urgent）", "default": "normal"}
                    },
                    "required": ["message"]
                }
            )
    ...
    async def call_tool(name: str, arguments: Any) -> List[TextContent]:
        ...
        try:
            ...
            # CivitAI
                ...
                result = call_api("/api/civitai/search", params={"query": args.get("query"), "limit": args.get("limit", 10)})
            ...
            # 記憶システム
                ...
                result = call_api("/api/memory/recall", params={
