...
# 新しいウィンドウでサーバーを起動
Start-Process python -ArgumentList "unified_api_server.py" -WorkingDirectory (Get-Location)
...
Write-Host "1. ブラウザで http://localhost:9500/health にアクセス" -ForegroundColor White
