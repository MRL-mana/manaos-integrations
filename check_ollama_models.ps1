...
try {
    $response = Invoke-WebRequest -Uri "$ollamaBaseUrl/api/tags" -UseBasicParsing -TimeoutSec 5
...
try {
    $response = Invoke-WebRequest -Uri "$ollamaBaseUrl/api/ps" -UseBasicParsing -TimeoutSec 5
