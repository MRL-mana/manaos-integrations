...
def google_drive_upload():
    ...
    if not drive or not drive.is_available():
        return jsonify({"error": "Google Driveが利用できません"}), 503
    
    file_id = drive.upload_file(file_path, folder_id, file_name)
...
if __name__ == "__main__":
    ...
    print("  POST /api/google_drive/upload - Google Driveアップロード")
    print("  GET  /api/civitai/search - CivitAIモデル検索")
