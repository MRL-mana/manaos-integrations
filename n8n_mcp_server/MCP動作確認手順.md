...
python -c "import os, requests; r = requests.get('http://127.0.0.1:5679/api/v1/workflows', headers={'X-N8N-API-KEY': os.environ['N8N_API_KEY']}); print('OK' if r.status_code == 200 else f'Error: {r.status_code}')"
```
...
1. n8nのWeb UIにアクセス: http://127.0.0.1:5679
