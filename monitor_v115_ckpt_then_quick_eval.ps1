param(
    [string]$OutDir = "D:\castle_ex_training\lora_castle_ex_layer2_v1_1_5_stylefix",
    [int]$CheckpointStep = 5000,
    [int]$PollSec = 120,
...
$monitorLog = Join-Path $logDir "monitor_v115_ck${CheckpointStep}_$timestamp.log"
$stdoutLog = Join-Path $logDir "layer2_quick_eval_v115_ck${CheckpointStep}_$timestamp.stdout.log"
$stderrLog = Join-Path $logDir "layer2_quick_eval_v115_ck${CheckpointStep}_$timestamp.stderr.log"
...
$gatePath = Join-Path $reportsDir "gate_v115_ck${CheckpointStep}_$timestamp.json"
