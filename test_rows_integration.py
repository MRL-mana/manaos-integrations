...
def test_send_data(spreadsheet_id: str):
    """データ送信テスト"""
    print("\n[5] データ送信テスト")
    print("-" * 60)
...
def test_ai_query(spreadsheet_id: str):
    """AI自然言語クエリテスト"""
    print("\n[6] AI自然言語クエリテスト")
    print("-" * 60)
    if not spreadsheet_id:
...
def test_ai_analyze(spreadsheet_id: str):
    """AIデータ分析テスト"""
    print("\n[7] AIデータ分析テスト")
    print("-" * 60)
    if not spreadsheet_id:
...
def main():
    ...
    # データ操作テスト
    if spreadsheet_id:
        test_send_data(spreadsheet_id)
        test_ai_query(spreadsheet_id)
        test_ai_analyze(spreadsheet_id)
